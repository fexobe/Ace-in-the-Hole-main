    ...
    <body>
        <main>
            ...
            <div class="bring">
                ...
                <p>
                     Watch the weather closely. The show goes on no matter what the weather is doing.<br><br>
                ...
                <div class="faq">
                    ...
                    <ul>
                        ...
                        <li>Can I use a personal music device while cycling?</li>
                        ...
                        <li>Can I use a personal music device while running?</li> 
                        ...
                        <li>Do I need to wear a wetsuit?</li>
                        <p> No, you do not need </p>

                        <li>Do I have to use a road or racing bike?</li>
